...
class Practicum {
    ...
    private static void printWorkHours(
        ...
        if (LocalDateTime.of(START_YEAR, JUNE, START_DAY, startHours, startMinutes) !> MAX_SHIFT) { // продолжительность смены не должна быть больше MAX_SHIFT часов
        ...
        for (int a = 1; a = shiftAmount; a++) { // цикл должен начинаться с 1, а количество итераций должно быть равно количеству смен
            ...
            startTime.plusDay(1); // обновите переменную startTime
        }
    }
}